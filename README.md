...
**LingoSync AI（中文名：灵犀同传）** 是一款 AI 同声传译助手。本仓库用于该项目的方案确认、需求拆解、开发迭代与评审资料沉淀。

## 最终选题

**选题二：AI 同声传译助手**（产品名：**LingoSync AI · 灵犀同传**）
...
当前已确认最终选题为 **AI 同声传译助手**，产品定名 **LingoSync AI（灵犀同传）**，并已搭建前后端基础结构。下一步按功能拆分 PR，优先完成实时字幕同传 MVP，包括音频输入、流式识别、中文翻译、字幕展示和历史字幕修正机制。
